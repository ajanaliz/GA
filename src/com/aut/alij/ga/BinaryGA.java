...
class BinaryGA
{
	private static int popSize = 30;				//population size
	private static int chromLength = 10;			//chromosome/solution/genotype
	private static double mutRate = 0.1;			//mutation rate, change it have a play
	private static double xoRate = 0.5;				//cross over rate
	private static double maxNoTour = 1000;			//how many tournaments should be played

	/*
	private static double roc = 0.5;				//radius of colinearity
	private static double dash_seperation = 1.5;	//min distance between two dashes to be considered adjacent
	the above two variables are not considered for the sake of simplicity
	*/
	...
	private static Dash[] dashes = {d1,d6,d2,d7,d3,d8,d4,d9,d5,d10};			// an array of the input line segments

	private static int[][] population = new int[popSize][chromLength];			//the chromosomes array, 30 members, 10 line segments each
